...
DSS.utils.addStyle('.fa-hover {opacity: 0.5; right: 1rem}');
...
DSS.utils.addStyle('.restriction-widget { background: #fff; border-radius: 2px; border-top-left-radius: 0.6rem; border-bottom-right-radius: 0.6rem}');
